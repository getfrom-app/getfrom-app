...
const TRANSLATIONS = {
  es: {
    ...
    "pricing.perpetual_desc":   "Paga una vez, tuyo para siempre",
  ...
  en: {
    ...
    "pricing.perpetual_desc":   "Pay once, yours forever",
  ...
  ,zh: {
    ...
    "pricing.comparison_title":"计划对比","pricing.comp_feature_col":"功能","pricing.comp_perpetual_col":"永久授权","pricing.comp_sub_col":"订阅","pricing.comp_row1":"笔记、任务、时间轴","pricing.comp_row2":"视图（看板、日历、列表、卡片）","pricing.comp_row3":"Apple 日历和提醒事项","pricing.comp_row4":"Google Drive & Docs","pricing.comp_row5":"自主代理","pricing.comp_row6":"无限画布","pricing.comp_row7":"使用自有 API 密钥的 AI","pricing.comp_row8":"连接 Claude 订阅","pricing.comp_row9":"托管 AI（无需 API 密钥）","pricing.comp_row9_sub":"✓ 每月 200 万 token","pricing.comp_row10":"优先支持",
