...
const TRANSLATIONS = {
  es: {
    ...
    "index.pricing_teaser_body":  "Prueba Fromly entero 15 días gratis: asistente por chat, notas, tareas. Pro desde €7/mes (o €49/año) con elementos ilimitados y la opción de usar tu propia clave de Claude, GPT o Gemini. O paga una vez, €149, y ten todo Pro para siempre con Lifetime.",
  ...
  en: {
    ...
    "index.pricing_teaser_body":  "Try all of Fromly free for 15 days: chat assistant, notes, tasks. Pro from €7/month (or €49/year) with unlimited elements and the option to use your own Claude, GPT or Gemini key. Or pay once, €149, and get all of Pro forever with Lifetime.",
