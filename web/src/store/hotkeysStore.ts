...
export const DEFAULT_HOTKEYS: HotkeyDef[] = [
  ...
  { id: 'go-today',         category: 'Captura',      label: 'Ir a hoy',                 description: 'Navegar a la nota del día de hoy (⌘D)',            defaultKey: 'd',          modifiers: ['meta'], configurable: true },
  ...
  { id: 'context-picker',   category: 'Outliner',     label: 'Mencionar contexto',       description: 'Picker de contextos y nodos (🧠 Contexto)',         defaultKey: '@',          configurable: false },
