...
En la **barra superior** tienes tres botones siempre visibles, en el mismo sitio:
...
- **📅 Calendario** — abre el **calendario del año** en la columna derecha: los 12 meses de un vistazo (mini-calendarios con los días en pequeño). Cambia de año con «‹ ›» y pulsa cualquier día para **viajar a él** — el calendario se cierra y vuelven la columna y el lienzo de ese día. Los días con contenido llevan un puntito.
