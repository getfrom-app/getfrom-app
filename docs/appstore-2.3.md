...
## Texto promocional (máx. 170 car — editable sin revisión)

```
Captura ideas, tareas y notas sin fricción. Todo sincronizado en tiempo real entre iPhone, Mac y web. Tu segundo cerebro, siempre contigo.
```

Alternativas:
- `Tu segundo cerebro en todos tus dispositivos. Notas, tareas y eventos que se sincronizan al instante. Captura sin fricción y deja que la IA te ayude.`
- `Tu segundo cerebro. Notas, tareas y agenda en un solo lugar, sincronizadas al instante en todos tus dispositivos. Con IA para capturar y organizar.`
- `Organiza tu vida en un outliner rápido y flexible. Sincronización en tiempo real, captura por voz y agentes de IA que trabajan por ti.`

---

## Novedades de esta versión (What's New — v2.3)

```
Nuevo motor de sincronización en tiempo real, más fiable y sin perder nada. Lo que creas desde Claude o tus agentes también aparece al instante. Mejoras de estabilidad.
```
...
• Tareas con fechas, prioridades y recurrencia.
• Eventos conectados con tu calendario.
• Contextos y filtros para ver justo lo que necesitas.
• Paneles y plantillas para tus flujos recurrentes.
...
## Keywords (máx. 100 car, separadas por comas, sin espacios tras la coma)

```
segundo cerebro,notas,tareas,outliner,productividad,sincronizar,diario,calendario,IA,ideas
```
